      ...
      <div class="col-md-12">
        <div class="widget">
          <div class="widget-header">
            <h2><strong>Table</strong> de sorties</h2>

            <div class="additional-btn">
           <a href="{{ route('add.sorties') }}"><button class="btn btn-success pull-right">Ajouter</button></a>
            </div>
          </div>
                      ...
                      <tbody>
                        @foreach($sorties as $sortie)
                          <tr>
                              ...
                              <td>{{ $sortie->fournisseur }}</td>
                               <td>{!! $sortie->solde = $sortie->quantite * $sortie->prix_unitaire !!}</td>
                              <td>
                          <div class="btn-group btn-group-xs">
                           <a href="{{ route('edit.sorties',$sortie->id) }}" class="btn btn-default"><i class="fa fa-edit"></i></a>
                            <a href="{{ route('delete.sorties',$sortie->id) }}" class="btn btn-default"><i class="fa fa-trash"></i></a>
