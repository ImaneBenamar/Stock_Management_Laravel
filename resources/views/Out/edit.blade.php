            ...
            <div class="widget">
                ...
                <div class="widget-content padding">
                    <div id="basic-form">
                        ...
                        <form action="{{ route('post.edit.sorties',$sorties->id) }}" method="POST" role="form">
                        <form action="" method="POST" role="form">
                            ...
                            <div class="form-group @if($errors->has('nfacture')) has-error @endif">
                                ...
                                <input type="text" class="form-control" value="{{ $sorties->numero_facture }}" name ="nfacture">
                            ...
                            <div class="form-group @if($errors->has('prix_uni')) has-error @endif">
                                ...
                                <input type="text" class="form-control" value="{{ $sorties->prix_unitaire }}" name="prix_uni" data-mask="999999" placeholder="999999">
                            ...
                            <div class="form-group @if($errors->has('fourni')) has-error @endif">
                                ...
                                <input type="text" class="form-control" value="{{ $sorties->fournisseur }}" name ="fourni">
