        ...
        <div class="col-md-6 col-md-offset-3 portlets ui-sortable">
            <div class="widget">
                <div class="widget-header transparent">
                    <h2 class="text-center"><strong>Modifier</strong> Entrés</h2>
                </div>
                <div class="widget-content padding">
                    <div id="basic-form">

                        {!! Form::model($entres,['route' => ['post.edit.entres', $entres->id],'method'=>'POST']) !!}
                        ...
                        <div class="form-group @if($errors->has('date')) has-error @endif">
                            ...
                            {{--<input type="text" class="form-control datepicker-input" value=""  name="date" data-mask="9999-99-99">--}}
                            @if($errors->has('date'))
                        ...
                        <div class="form-group @if($errors->has('nfacture')) has-error @endif">
                            ...
                            <input type="text" class="form-control" value="{{ $entres->numero_facture }}" name ="nfacture">
                            {{--<input type="text" class="form-control" value="" name ="nfacture">--}}
                        ...
                        <div class="form-group @if($errors->has('quantite')) has-error @endif">
                            ...
                            {{--<input type="text" class="form-control" value="" name="quantite" data-mask="999999" placeholder="999999">--}}
                        ...
                        <div class="form-group @if($errors->has('prix_uni')) has-error @endif">
                            ...
                            <input type="text" class="form-control" value="{{ $entres->prix_unitaire }}" name="prix_uni" data-mask="999999" placeholder="999999">
                            {{--<input type="text" class="form-control" value="" name="prix_uni" data-mask="999999" placeholder="999999">--}}
                        ...
                        <div class="form-group @if($errors->has('fourni')) has-error @endif">
                            ...
                            <input type="text" class="form-control" value="{{ $entres->fournisseur }}" name ="fourni">
                            {{--<input type="text" class="form-control" value="" name ="fourni">--}}
