        ...
        <div class="col-md-6 col-md-offset-3 portlets ui-sortable">
            <div class="widget">
                ...
                <div class="widget-content padding">
                    <div id="basic-form">
                        <form action="{{ route('post.edit.generation',$generation->id) }}" method="POST" role="form">
                            ...
                            <div class="form-group @if($errors->has('nfacture')) has-error @endif">
                                ...
                                <input type="text" class="form-control" value="{{ $generation->numero_facture }}" name ="nfacture">
                            ...
                            <div class="form-group @if($errors->has('prix_uni')) has-error @endif">
                                ...
                                <input type="text" class="form-control" value="{{ $generation->prix_unitaire }}" name="prix_uni" data-mask="999999" placeholder="999999">
                            ...
                            <div class="form-group @if($errors->has('fourni')) has-error @endif">
                                ...
                                <input type="text" class="form-control" value="{{ $generation->fournisseur }}" name ="fourni">
...
@section('scripts')
  ...
  <script>
       $('#active-generhistorical').addClass('active');
</script>
@endsection
